...
public class MovieTrailersAdapter extends RecyclerView.Adapter<MovieTrailersAdapter.ViewHolder>{
    ...
    private final static String LOG_TAG = MovieTrailersAdapter.class.getSimpleName();
    ...
    public MovieTrailersAdapter(ArrayList<Trailer> mTrailers, Callbacks mCallbacks) {
